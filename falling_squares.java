...
public class falling_squares extends JPanel {
    ...
    static int squareYLocation = -squareHeight;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        class SquareClicker extends MouseAdapter {
            ...
            public void mousePressed(MouseEvent e) {
                    if ((e.getX() >= tab[0] && e.getX() <= tab[0] + 25) && (e.getY() >= squareYLocationA[0] && e.getY() <= squareYLocationA[0] + 25) && isClicked[0] == false) {
                        isClicked[0] = true;
                ...
                if ((e.getX() >= tab[1] && e.getX() <= tab[1] + 25) && (e.getY() >= squareYLocationA[1] && e.getY() <= squareYLocationA[1] + 25) && isClicked[1] == false) {
                    isClicked[1] = true;
                ...
                if ((e.getX() >= tab[2] && e.getX() <= tab[2] + 25) && (e.getY() >= squareYLocationA[2] && e.getY() <= squareYLocationA[2] + 25) && isClicked[2] == false) {
                    isClicked[2] = true;
                ...
                if ((e.getX() >= tab[3] && e.getX() <= tab[3] + 25) && (e.getY() >= squareYLocationA[3] && e.getY() <= squareYLocationA[3] + 25) && isClicked[3] == false) {
                    isClicked[3] = true;
        ...
        while (gameRunning) {
            if (squareYLocationA[0] >= 400 && isClicked[0] == false) {
                squaresRatio = counter/squareCounter*100;
                DecimalFormat myDF2 = new DecimalFormat("0");
                score.setText("Current score: " + myDF2.format(squaresRatio) + "%");
            }
            if (squareYLocationA[1] >= 400 && isClicked[1] == false) {
                squaresRatio = counter/squareCounter*100;
                DecimalFormat myDF2 = new DecimalFormat("0");
                score.setText("Current score: " + myDF2.format(squaresRatio) + "%");
            }
            if (squareYLocationA[2] >= 400 && isClicked[2] == false) {
                squaresRatio = counter/squareCounter*100;
                DecimalFormat myDF2 = new DecimalFormat("0");
                score.setText("Current score: " + myDF2.format(squaresRatio) + "%");
            }
            if (squareYLocationA[3] >= 400 && isClicked[3] == false) {
                squaresRatio = counter/squareCounter*100;
                DecimalFormat myDF2 = new DecimalFormat("0");
                score.setText("Current score: " + myDF2.format(squaresRatio) + "%");
            }
